...
class TicketCategoryNotFoundException extends Exception
{
    protected $message;
     ...
     */
    public function __construct(string $message = "Ticket Category not found", int $statusCode = Response::HTTP_NOT_FOUND)
    {
