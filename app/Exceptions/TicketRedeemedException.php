...
class TicketRedeemedException extends Exception
{
    protected $message;
     ...
     */
    public function __construct(string $message = "Ticket already redeemed", int $statusCode = Response::HTTP_BAD_REQUEST)
    {
